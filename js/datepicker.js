    ...
    var DatePicker = function () {
            var ids = {},
                ...
                tpl = {
                    ...
                    ranges: ['<div class="datepickerRanges"><select class="ranges"><option>Personalizado</option></select><input class="start" type="text" disabled="disabled"><input class="end" type="text" disabled="disabled">​<button class="btn" value="Aplicar fechas">​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​Aplicar fechas</div>']
                },
                defaults = {
                    /**
                    ...
                    lastSel: false,
                    /**
                     * Ranges ( preset of defined ranges )
                     **/
                    ranges: {
                        'Today': ['today', 'today'],
                    ...
                    /**
                     * enable / disable showing preset of ranges
                     **/
                    showRanges: false
                ...
                initRanges = function (el, cal, ranges, onApplyFn) {
                    ...
                    for (var key in ranges) {
                        $option = $('<option >' + key + '</option>').data('range-from', ranges[key][0]).data('range-to', ranges[key][1])

                        $select.append($option);
                    }

                    /**
                     * Update calendar when changing the options
                     **/
